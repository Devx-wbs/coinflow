    ...
    @if($user?->canAccessModule('subscribe-'))
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('subscribe-store') ? 'active' : '') }}" href="{{ route('subscribe-store') }}">
          ...
          <span class="nav-link-text ms-1"> Subscribe Stores </span>
        </a>
      </li>
      @endif
...
@if($user?->canAccessModule('license-'))
       <li class="nav-item">
        <a class="nav-link {{ (Request::is('license-managment') ? 'active' : '') }}" href="{{ route('license-managment') }}">
          ...
          <span class="nav-link-text ms-1">License Management</span>
        </a>
      </li>
      @endif
      ...
      <!-- @if($user && ($user->role == 1 || $user->canany(['global_stats_view', 'global_stats_edit'])))
       ...
       <li class="nav-item">
        <a class="nav-link {{ (Request::is('global-stats') ? 'active' : '') }}" href="{{ route('global-stats') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Global Stats</span>
        </a>
      </li>
      @endif -->
      <!-- test -->
...
@if($user?->canAccessModule('logs-'))
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('logs-error') ? 'active' : '') }}" href="{{ url('logs-error') }}">
          ...
          <span class="nav-link-text ms-1">Logs & Errors</span>
        </a>
      </li>
      @endif
      ...
      <li class="nav-item">
        ...
        <a class="nav-link {{ Route::is('merchant-contact') ? 'active' : '' }}" href="{{ route('merchant-contact') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">Merchant Contacts</span>
        </a>
      </li>
      @endif
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('update-tracker') ? 'active' : '') }}" href="{{ route('update-tracker') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>spaceship</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
     ...
     <li class="nav-item pb-2">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('tables') ? 'active' : '') }}" href="{{ url('tables') }}">
          ...
          <span class="nav-link-text ms-1">View licence Key</span>
        </a>
      </li>
      <li class="nav-item">
